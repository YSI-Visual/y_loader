...
[![sampctl](https://shields.southcla.ws/badge/sampctl-y_loader-2f2f2f.svg?style=for-the-badge)](https://github.com/YSI-Visual/y_loader)
...
```bash
sampctl package install YSI-Visual/y_loader
```

Include in your code and begin using the library:

```pawn
#include <YSI-Visual/y_loader>
```

## Documentation

* [Quick Start](YSI-Visual/y_loader/quick-start.md) - One very simple example of getting started with this library.
* [Features](YSI-Visual/y_loader/features.md) - More features and examples.
* [FAQs](YSI-Visual/y_loader/faqs.md) - Frequently Asked Questions, including errors and solutions.
* [API](YSI-Visual/y_loader/api.md) - Full list of all functions and their meaning.
* [Internal](YSI-Visual/y_loader/internal.md) - Internal developer documentation for the system.
